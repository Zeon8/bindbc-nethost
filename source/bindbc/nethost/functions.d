module bindbc.nethost.functions;
...
alias hostfxr_initialize_for_dotnet_command_line_fn = extern(C) int function(
    int argc, char_t* argv, hostfxr_initialize_parameters* parameters,
    hostfxr_handle* host_context_handle);

alias hostfxr_initialize_for_runtime_config_fn = extern(C) int function(
    char_t* runtime_config_path,
    hostfxr_initialize_parameters* parameters,
    hostfxr_handle* host_context_handle);

alias hostfxr_get_runtime_property_value_fn = extern(C) int function(
    hostfxr_handle host_context_handle,
    char_t* name,
    /*out*/ char_t** value);

alias hostfxr_set_runtime_property_value_fn = extern(C) int function(
    hostfxr_handle host_context_handle,
    char_t* name,
    char_t* value);

alias hostfxr_get_runtime_properties_fn = extern(C) int function(
    hostfxr_handle host_context_handle,
    /*inout*/ size_t* count,
    /*out*/ char_t** keys,
    /*out*/ char_t** values);

alias hostfxr_run_app_fn = extern(C) int function(hostfxr_handle host_context_handle);

alias hostfxr_get_runtime_delegate_fn = extern(C) int function(
    hostfxr_handle host_context_handle,
    hostfxr_delegate_type type,
    /*out*/ void** deleg);

alias hostfxr_close_fn = extern(C) int function(hostfxr_handle host_context_handle);

alias hostfxr_get_dotnet_environment_info_result_fn = extern(C) void function(
    hostfxr_dotnet_environment_info* info,
    void* result_context);

alias hostfxr_get_dotnet_environment_info_fn = extern(C) int function(
    char_t* dotnet_root,
    void* reserved,
